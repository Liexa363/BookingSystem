...
struct ManagerAboutBookingView: View {
...
#Preview {
    ManagerAboutBookingView(selectedTab: .constant(.managerAboutBooking), user: .constant(nil), selectedBooking: .constant(nil))
}
